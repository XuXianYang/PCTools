...
@interface PCStringPickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation PCStringPickerView
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    PCStringPickerView *strPickerView = [[PCStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, kTopViewHeight + 0.5, kScreenW, kDatePicHeight)];
